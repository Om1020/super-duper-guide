...
public class Subscriptions extends BaseTest{
	...
	public Subscriptions(String browser) {
		super(browser);
	}
	...
	public void subscription() throws Exception
	{
		...
		reportLog("Click on subscriptions");
		subscriptionPage=servicePage.clickOnSubscriptions();
		
		reportLog("verify subscription page");
		subscriptionPage.verifySubscriptionPage();
		
		reportLog("search user");
		subscriptionPage.searchUser(userModel);
		
		reportLog("click on subscribe");
		subscriptionPage.clickOnSubscribe();
